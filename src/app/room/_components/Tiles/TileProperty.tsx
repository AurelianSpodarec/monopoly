...
function TileProperty({ tile, direction, reverse }: any) {
  ...
  return (
    ...
    >
      ...
      <div className={`z-10 flex items-center flex-col ${direction === "top" ? "flex-col-reverse" : "flex-col"}`}>
        ...
        <div className="items-center text-xs leading-3" style={{ marginBlockEnd: "1.5rem", marginBlockStart: "1.5rem", textShadow: "0 0 0.5em #262a4c" }}>
          <p>{tile && tile?.name}</p>
        </div>
      </div>

...
function IconEditCheck() {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      className="svg-inline--fa fa-money-check-dollar-pen RocF3PQU"
      data-icon="money-check-dollar-pen"
      data-prefix="fad"
      viewBox="0 0 640 512"
    >

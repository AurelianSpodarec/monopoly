...
function Tile({ tile, direction, reverse }: any) {
  return (
    <div className={`flex items-center text-white bg-[#262a4c] cursor-pointer justify-between rounded-lg relative flex-col ${reverse ? "flex-col-reverse" : "flex-col"}`} style={{ blockSize: "6.5rem", flex: "1 0 0", minInlineSize: "4.25rem" }}>
      ...
      <div className={`z-10 flex items-center flex-col ${reverse ? "flex-col-reverse" : "flex-col"}`}>
        <div className="h-8 w-8 rounded-full overflow-hidden" style={{ marginBlockEnd: "-1rem", marginBlockStart: "-1rem" }}>
          {tile.icon}
        </div>
